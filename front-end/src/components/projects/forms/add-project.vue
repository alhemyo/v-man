        ...
        watch: {
            ...
            name() {
                ...
                if ( this.name === "" ) {
                    ...
                    $('.project-name').removeClass('success').addClass('error').prop('placeholder', 'Name is required')
                }

                else if ( !this.name.match(this.$store.state.regex.letters) ) {

                    $('.project-name').removeClass('success').addClass('error')
                }

                else [

                    $('.project-name').removeClass('error').addClass('success')
                ]
            ...
            deadlineDay() {
                ...
                if ( this.deadlineDay === "" ) {
                    ...
                    $('.deadline').removeClass('success').addClass('error')
                }

                else if ( !this.deadlineDay.match(this.$store.state.regex.numbers) ) {
                    ...
                    $('.deadline').removeClass('error').addClass('success')
                }
            },

            deadlineMonth() {

                if ( this.deadlineMonth === "" ) {

                    $('.deadline').removeClass('success').addClass('error')
                }

                else if ( !this.deadlineMonth.match(this.$store.state.regex.numbers) ) {
            ...
            deadlineYear() {
                ...
                if ( this.deadlineYear === "" ) {

                    $('.deadline').removeClass('success').addClass('error')
                }

                else if ( !this.deadlineYear.match(this.$store.state.regex.numbers) ) {
